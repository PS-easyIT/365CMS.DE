...
Aktueller Bestand (13 PNG-Dateien):

| Datei | Abmessungen | Rolle |
|---|---:|---|
| `365CMS-DASHBOARD-Admin-100px.png` | 90 × 100 px | Admin-Dashboard |
| `365CMS-DASHBOARD-Member-100px.png` | 90 × 100 px | Member-Dashboard |
| `LOGO_365CMS-75px.png` | 101 × 75 px | kompaktes Logo |
| `LOGO_365CMS-100px.png` | 135 × 100 px | Standard-Logo |
| `LOGO_365CMS-120px.png` | 280 × 120 px | breites Header-Logo |
| `LOGO_365CMS-125px.png` | 169 × 125 px | mittleres Logo |
| `LOGO_365CMS-150px.png` | 203 × 150 px | großes Logo |
...
Die ausführliche Asset-Dokumentation liegt unter
[`DOC/assets/images/README.md`](assets/images/README.md).
