...
### User-friendly
Release 3.4.00 is stable and targets PHP 8.4+. Core startup, routing, database, security, themes, plugins, member features and updates are production-ready; planned items remain separate.

### Technical
The code declares version `3.4.00`, release date `2026-09-05` and stable status. Bootstrap validates bundled platform requirements; the schema baseline contains 44 core tables; API routes include status, pages, web vitals, admin lists, upload and media. The complete detailed status is retained in the German technical section below.

## Deutsch

### Anwenderfreundlich
Release 3.4.00 ist stabil und für PHP 8.4+ vorgesehen. Start, Routing, Datenbank, Sicherheit, Themes, Plugins, Member-Funktionen und Updates sind produktiv.
...
- [Wichtige Feature-Stände](#wichtige-feature-stände-im-aktuellen-stand-3400)
...
- **44 Basistabellen** aus `SchemaManager`
...
## Wichtige Feature-Stände im aktuellen Stand 3.4.00 <!-- UPDATED: 2026-09-06 -->
...
## Verifizierter Core-Stand `3.4.00` <!-- UPDATED: 2026-09-06 -->

Der Status wurde gegen `CMS/core/Version.php`, `CMS/core/Bootstrap.php`,
`CMS/core/Routing/ApiRouter.php` und `CMS/core/SchemaManager.php` geprüft.

- `CMS_VERSION`: `3.4.00`
- Release-Datum im Code: `2026-09-05`
- PHP-Mindestplattform: `8.4+`
- `SchemaManager`: 44 idempotent angelegte Core-Tabellen
- API-Routen umfassen Status, Seiten, Web Vitals, Admin-Listen, Upload und Medien
- Cron-/Hook-Registrierung umfasst Mail-Queue, SEO-/Monitoring-/Security-Trends und Sitemap-Refresh
...
## Release-Notiz 3.4.00 <!-- ADDED: 2026-09-06 -->
