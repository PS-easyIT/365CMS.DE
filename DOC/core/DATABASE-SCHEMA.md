...
### User-friendly
This document explains which database structures are created by the CMS core and which data each area stores. Use it before backups, upgrades, diagnostics or custom integrations.

### Technical
`SchemaManager` creates the idempotent baseline schema; `MigrationManager` applies incremental changes. Queries use the `Database` abstraction and prepared parameters. The complete detailed schema reference is retained in the German technical section below.

## Deutsch

### Anwenderfreundlich
Diese Referenz zeigt, welche Tabellen der Core anlegt und welche Daten darin gespeichert werden. Sie ist für Backups, Updates, Diagnose und Integrationen relevant.
...
Wichtig für den Stand `3.4.00`: Nicht jede Laufzeitfunktion hängt heute primär an SQL-Tabellen. Die Medienbibliothek nutzt für Kategorien und Datei-Metadaten inzwischen vor allem `CMS/config/media-meta.json` plus Dateisystem-Repository; ältere Tabellenreferenzen sind daher als Legacy-/Migrationskontext zu lesen. Beitragskategorien besitzen keine Kategorie-Zusatzdomains mehr; Domain-Zuordnungen bleiben Hub-Site-Funktionalität.

### Verifizierter Tabellenumfang

`CMS/core/SchemaManager.php` definiert aktuell 44 Basistabellen. Ergänzende
Tabellen werden bei Bedarf von spezialisierten Services angelegt, unter anderem
für Fehlerreports, Feature Usage, SEO-/Monitoring-Trends, Redirects,
Firewall-Regeln und AI-Quota-Nutzung. Diese Service-Tabellen sind deshalb
nicht als zusätzliche SchemaManager-Basistabellen zu zählen.
...
## Schema-Übersicht nach Bereichen <!-- UPDATED: 2026-09-06 -->
...
## Content-Tabellen <!-- UPDATED: 2026-09-06 -->
...
Historische bzw. optionale Tabellenstruktur für hochgeladene Dateien. Im aktuellen Stand `3.4.00` arbeitet die produktive Medienbibliothek jedoch primär über `CMS/core/Services/MediaService.php`, `CMS/core/Services/Media/MediaRepository.php`, das Dateisystem unter `uploads/` und `CMS/config/media-meta.json`.
...
## User-Tabellen <!-- UPDATED: 2026-09-06 -->
...
## SEO-Tabellen <!-- UPDATED: 2026-09-06 -->
...
## Subscription-Tabellen <!-- UPDATED: 2026-09-06 -->
...
## Beziehungen <!-- UPDATED: 2026-09-06 -->
...
## Migrations-System <!-- UPDATED: 2026-09-06 -->
...
## Zugriffsregeln für Entwickler <!-- UPDATED: 2026-09-06 -->
