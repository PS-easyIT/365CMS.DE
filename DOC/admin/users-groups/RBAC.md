...
Dieses Dokument beschreibt Zugriffskontrolle und Sicherheitsvorgänge. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/rbac`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
