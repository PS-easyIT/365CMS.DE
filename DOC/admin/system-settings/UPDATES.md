...
Dieses Dokument beschreibt Systemwartung und Erweiterungen. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/updates`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
