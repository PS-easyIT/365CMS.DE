...
Dieses Dokument beschreibt themes, design, and navigation. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/design-settings`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
