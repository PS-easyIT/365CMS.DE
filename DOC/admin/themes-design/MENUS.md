...
Dieses Dokument beschreibt Themes, Design und Navigation. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/menu-editor`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
