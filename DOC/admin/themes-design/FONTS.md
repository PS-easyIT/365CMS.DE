...
Dieses Dokument beschreibt Medien- und Upload-Workflows. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/font-manager`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
