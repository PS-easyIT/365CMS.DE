...
Dieses Dokument beschreibt das Administrator-Dashboard. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/member-dashboard-widgets`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
