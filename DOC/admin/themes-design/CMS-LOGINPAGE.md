...
Dieses Dokument beschreibt Betrieb, Protokolle und Überwachung. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/cms-loginpage`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
