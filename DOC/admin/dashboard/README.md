...
| Bereich | Inhalt |
|---|---|
| KPI-Karten | z. B. Inhalte, Benutzer, Medien oder Systemkennzahlen |
| Systemstatus | wichtige Warnungen oder Betriebszustände |
| Schnellzugriffe | Links zu oft genutzten Admin-Aufgaben |
| Aktivitätsbezug | letzte relevante Änderungen oder Aktionen |
