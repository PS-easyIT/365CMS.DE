...
Dieses Dokument beschreibt media and upload workflows. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/media`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
