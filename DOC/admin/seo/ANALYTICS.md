...
Dieses Dokument beschreibt SEO, analytics, and redirect management. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/analytics`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
