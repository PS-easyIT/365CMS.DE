...
Dieses Dokument beschreibt subscriptions, packages, and orders. Öffnen Sie nach der Anmeldung über den Admin-Einstieg die Route `/admin/orders`. Die Sidebar berücksichtigt Capabilities; ein fehlender Menüpunkt bedeutet, dass Benutzer, Modulstatus oder Feature-Gate den Vorgang nicht erlauben.
