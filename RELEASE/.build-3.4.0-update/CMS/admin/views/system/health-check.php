...
$passed = (int) ($health['passed'] ?? 0);
$total = max(1, (int) ($health['total'] ?? 0));
$failed = max(0, $total - $passed);
$progress = (int) round(($passed / $total) * 100);
$progressClass = $failed >= 2 ? 'is-danger' : ($failed === 1 ? 'is-warning' : 'is-success');
?>
