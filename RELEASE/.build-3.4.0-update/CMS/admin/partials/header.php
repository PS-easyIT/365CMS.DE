...
<head>
    ...
    <!-- Local Tabler Icons webfont (CDN/runtime external assets are forbidden) -->
    <link rel="stylesheet" href="<?= htmlspecialchars(cms_asset_url('tabler-icons/tabler-icons.min.css'), ENT_QUOTES) ?>">
