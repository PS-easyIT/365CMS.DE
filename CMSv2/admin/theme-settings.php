...
<head>
    ...
    <style>
        .alert          { padding: .875rem 1.25rem; border-radius: 6px; margin-bottom: 1.25rem; font-size: .875rem; }
        ...
        .sc-header h3 { margin: 0; font-size: .9375rem; font-weight: 700; color: #1e293b; }
        .sc-header p  { margin: .15rem 0 0; font-size: .8rem; color: #64748b; }

        .sc-body { padding: 1.25rem 1.5rem; display: grid; gap: 1.25rem; }
        ...
        .form-label { font-size: .8125rem; font-weight: 600; color: #374151; padding-top: .375rem; }
        ...
        input[type="checkbox"] { width: 1rem; height: 1rem; accent-color: #2563eb; cursor: pointer; }
        ...
        .info-box-cs strong { display: block; margin-bottom: .25rem; color: #92400e; }
    </style>
</head>
