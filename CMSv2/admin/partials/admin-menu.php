        ...
        [
            ...
            'children' => [
                [
                    ...
                    'active' => (_adminNavIsActive('/admin/landing-page') && empty($_GET['tab'])) || (_adminNavIsActive('/admin/landing-page') && ($_GET['tab'] ?? '') === 'landing'),
                ],
                [
                    'slug'   => 'landing-colors',
                    'label'  => 'Farben',
                    'icon'   => '🎨',
                    'url'    => '/admin/landing-page?tab=colors',
                    'active' => _adminNavIsActive('/admin/landing-page?tab=colors'),
                ],
            ],
        ],
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'icon'   => '🫂',
                    'url'    => '/admin/groups',
                    'active' => _adminNavIsActive('/admin/groups') || $currentPage === 'groups',
                ],
            ],
        ],
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'icon'   => '🫂',
                    'url'    => '/admin/groups', 
                    'active' => _adminNavIsActive('/admin/groups') || $currentPage === 'subscriptions-groups',
                ],
            ],
        ],
