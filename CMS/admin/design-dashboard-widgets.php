...
<head>
    ...
    <style>
        ...
        @media (max-width: 900px) { .dw-grid-2 { grid-template-columns: 1fr; } }
        ...
        .dw-card + .dw-card { margin-top: 1.25rem; }
        ...
        .dw-form-group textarea { min-height: 80px; resize: vertical; }
        ...
        .dw-toggle-info strong { display: block; font-size: .875rem; color: #1e293b; }
        .dw-toggle-info span   { font-size: .75rem; color: #94a3b8; }
        .dw-toggle { position: relative; display: inline-block; width: 44px; height: 24px; flex-shrink: 0; }
        ...
        .dw-preview-box {
            ...
            border-radius: 8px; padding: 1rem 1.25rem; margin-top: .75rem;
        }
        ...
        .dw-col-option {
            ...
            padding: .875rem .75rem; text-align: center; cursor: pointer;
        ...
        .dw-col-preview { display: flex; gap: 4px; justify-content: center; margin-bottom: .4rem; }
        .dw-col-cell { height: 32px; background: #c7d2fe; border-radius: 3px; }
        .dw-col-option span { font-size: .8125rem; font-weight: 600; color: #4f46e5; }

        /* ─── Section Sorter (Drag & Drop) ─── */
        .dw-section-list {
        ...
        .dw-section-item:active { cursor: grabbing; }
        .dw-section-item.drag-over {
            border-color: #6366f1; background: #eef2ff;
            box-shadow: 0 0 0 2px rgba(99,102,241,.25);
        }
        .dw-section-item.dragging { opacity: .4; }
        .dw-section-handle { color: #94a3b8; font-size: 1rem; cursor: grab; }
        .dw-section-icon   { font-size: 1.25rem; }
        .dw-section-info   { flex: 1; }
        .dw-section-info strong { display: block; font-size: .875rem; color: #1e293b; }
        ...
        .dw-color-row input[type=color] {
            ...
            border-radius: 8px; cursor: pointer; padding: 2px; background: none; flex-shrink: 0;
        }
        ...
        .dw-design-preview-title { font-size: .9375rem; font-weight: 700; margin: 0 0 .75rem; }

        /* ─── Settings Checkboxes ─── */
        .dw-checkbox-group { display: flex; align-items: center; gap: .6rem; margin: .4rem 0; }
        .dw-checkbox-group input[type=checkbox] { width: 16px; height: 16px; accent-color: #6366f1; cursor: pointer; }
        .dw-checkbox-group label { font-size: .875rem; color: #374151; cursor: pointer; margin: 0; font-weight: 500; }
        ...
        .dw-section-divider {
            ...
            letter-spacing: .08em; color: #94a3b8; margin: 1.5rem 0 .75rem;
            display: flex; align-items: center; gap: .5rem;
        }
        .dw-section-divider::after {
