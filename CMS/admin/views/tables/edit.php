        ...
        <div class="content-listing-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    ...
                    <h2 class="page-title mb-1"><?php echo $isNew ? 'Neue Tabelle' : 'Tabelle bearbeiten'; ?></h2>
                    <?php if (!$isNew): ?>
                        <div class="content-listing-header__meta">
                            <span>Shortcodes: <code>[site-table id="<?php echo (int)$table['id']; ?>"]</code></span>
                            <span><code>[table id=<?php echo (int)$table['id']; ?> /]</code></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
