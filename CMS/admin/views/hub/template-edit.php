        ...
        <form method="post" action="<?php echo htmlspecialchars(SITE_URL); ?>/admin/hub-sites" id="hubTemplateForm">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-7">
                                    ...
                                    <div class="form-hint">Hier kannst du Templates umbenennen. Der interne Key bleibt stabil, damit bestehende Hub-Sites nicht brechen.</div>
                                </div>
                                <div class="col-md-5">
                    ...
                    <div class="card mb-3">
                        <div class="card-header"><h3 class="card-title">Template-Meta</h3></div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6"><label class="form-label">Zielgruppe</label><input type="text" class="form-control" name="template_meta_audience" value="<?php echo htmlspecialchars((string)($templateMeta['audience'] ?? '')); ?>"></div>
                                <div class="col-md-6"><label class="form-label">Verantwortlich</label><input type="text" class="form-control" name="template_meta_owner" value="<?php echo htmlspecialchars((string)($templateMeta['owner'] ?? '')); ?>"></div>
                                <div class="col-md-4"><label class="form-label">Update-Zyklus</label><input type="text" class="form-control" name="template_meta_update_cycle" value="<?php echo htmlspecialchars((string)($templateMeta['update_cycle'] ?? '')); ?>"></div>
                                <div class="col-md-4"><label class="form-label">Fokus</label><input type="text" class="form-control" name="template_meta_focus" value="<?php echo htmlspecialchars((string)($templateMeta['focus'] ?? '')); ?>"></div>
                                <div class="col-md-4"><label class="form-label">KPI</label><input type="text" class="form-control" name="template_meta_kpi" value="<?php echo htmlspecialchars((string)($templateMeta['kpi'] ?? '')); ?>"></div>
                            </div>
                        </div>
                    </div>

                    <div class="card mb-3">
                        <div class="card-header"><h3 class="card-title">Card-Layout</h3></div>
                        <div class="card-body">
                            <div class="row g-3">
                ...
                <div class="col-lg-4">
                    <div class="card mb-3">
                        ...
                        <div class="card-body text-secondary small">
                            Änderungen hier wirken sich auf alle Hub-Sites aus, die dieses Template-Profil verwenden.
                        </div>
                    </div>
