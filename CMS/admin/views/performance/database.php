...
<div class="page-body admin-redesign-page"><div class="container-xl admin-redesign-shell">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title mb-0">Kapazitäts-Pre-Check vor DB-Wartung</h3>
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <div class="alert alert-success mb-0">Keine akuten Engpässe erkannt. Die DB-Wartung hat aktuell genug Luft unter den Flügeln.</div>
            <?php endif; ?>
