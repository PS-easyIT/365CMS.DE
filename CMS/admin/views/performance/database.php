...
<div class="page-body"><div class="container-xl">
    ...
    <div class="row row-cards mb-4">
        <div class="col-md-6"><div class="card h-100"><div class="card-header"><h3 class="card-title">Wartungsaktionen</h3></div><div class="card-body d-flex flex-column gap-3"><div class="alert alert-warning mb-0">Tabellenwartung kann je nach Engine Tabellen sperren oder neu aufbauen. Am besten außerhalb der Stoßzeiten und nach aktuellem Backup ausführen. Nicht unterstützte Engines werden übersprungen; REPAIR läuft bewusst nicht auf InnoDB.</div><form method="post" data-confirm-title="Tabellen optimieren" data-confirm-message="Datenbanktabellen wirklich optimieren? Der Wartungslauf arbeitet sofort auf dem Live-Datenbestand und kann Tabellen kurzzeitig sperren oder neu aufbauen." data-confirm-text="Optimieren" data-confirm-class="btn-warning" data-confirm-status-class="bg-warning"><input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken ?? ''); ?>"><input type="hidden" name="action" value="optimize_database"><button type="submit" class="btn btn-primary w-100">Tabellen optimieren</button></form><form method="post" data-confirm-title="Tabellen reparieren" data-confirm-message="Tabellen wirklich prüfen und reparieren? REPAIR wird nur für unterstützte Engines ausgeführt und sollte nur bei konkretem Verdacht oder Wartungsfenster laufen." data-confirm-text="Prüfen & reparieren" data-confirm-class="btn-warning" data-confirm-status-class="bg-warning"><input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($csrfToken ?? ''); ?>"><input type="hidden" name="action" value="repair_tables"><button type="submit" class="btn btn-outline-warning w-100">Tabellen reparieren</button></form></div></div></div>
