...
?>
<div class="page-header d-print-none"><div class="container-xl"><div class="row g-2 align-items-center"><div class="col"><div class="page-pretitle">SEO</div><h2 class="page-title">Strukturierte Daten</h2></div></div></div></div>
<div class="page-body"><div class="container-xl">
    ...
    <div class="row g-4">
        <div class="col-lg-7"><div class="card h-100"><div class="card-header"><h3 class="card-title">Schema-Standards</h3></div><div class="card-body">
            <form method="post" class="row g-3">
                <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>"><input type="hidden" name="action" value="save_schema_defaults">
        ...
        <div class="col-lg-5"><div class="card mb-4"><div class="card-header"><h3 class="card-title">Verteilung</h3></div><div class="table-responsive"><table class="table card-table table-vcenter"><thead><tr><th>Typ</th><th class="text-end">Anzahl</th></tr></thead><tbody><?php foreach ($distribution as $row): ?><tr><td><?= htmlspecialchars((string)$row['schema_type']) ?></td><td class="text-end"><?= (int)$row['count'] ?></td></tr><?php endforeach; ?></tbody></table></div></div><div class="card"><div class="card-header"><h3 class="card-title">Unterstützte Typen</h3></div><div class="card-body d-flex flex-wrap gap-2"><?php foreach ($supportedTypes as $type): ?><span class="badge bg-azure-lt text-azure"><?= htmlspecialchars((string)$type) ?></span><?php endforeach; ?></div></div></div>
    </div>
</div></div>
