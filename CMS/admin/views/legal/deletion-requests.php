    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Löschanträge</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="alert alert-warning mb-4">
    <strong>DSGVO Art. 17 – Recht auf Löschung:</strong> Betroffene Personen haben das Recht, die Löschung ihrer personenbezogenen Daten zu verlangen. Die Löschung muss innerhalb eines Monats erfolgen. <strong>Achtung:</strong> Eine Löschung anonymisiert Benutzerdaten unwiderruflich!
</div>
