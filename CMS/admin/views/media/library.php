...
$finderUrl = (string)($data['finder_url'] ?? $baseUrl);
                    ...
                    <div class="media-toolbar">
                        ...
                        <div class="media-toolbar-right <?php echo $view !== 'finder' ? 'media-toolbar-right--browse' : ''; ?>">
                            ...
                            <div class="media-view-toggle" role="group" aria-label="Ansicht umschalten">
                                <a href="<?php echo htmlspecialchars($finderUrl); ?>" class="btn media-view-primary <?php echo $view === 'finder' ? 'active' : ''; ?>">
                                ...
                                <div class="media-view-secondary" aria-label="Alternative Ansichten">
                                    ...
                                    <div class="media-view-alt-group">
                                        <a href="<?php echo htmlspecialchars($listUrl); ?>" class="btn media-view-alt <?php echo $view === 'list' ? 'active' : ''; ?>">
                                            <span class="media-view-icon" aria-hidden="true">≣</span>
                                            Liste
                                        </a>
                                        <a href="<?php echo htmlspecialchars($gridUrl); ?>" class="btn media-view-alt <?php echo $view === 'grid' ? 'active' : ''; ?>">
                                            <span class="media-view-icon" aria-hidden="true">⊞</span>
                                            Grid
                                        </a>
                                    </div>
