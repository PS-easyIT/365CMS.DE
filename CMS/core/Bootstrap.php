    ...
    private function initializeCore(): void
    {
        ...
        if ($this->mode === 'web') {
            ...
            Hooks::addAction('head', static function (): void {
                ...
                $criticalCss = '.editorjs-block{--cms-editorjs-default-space-after:1.1rem;--cms-editorjs-space-before:0rem;--cms-editorjs-space-after:var(--cms-editorjs-default-space-after);box-sizing:border-box;display:block;max-width:100%;margin-block-start:var(--cms-editorjs-space-before)!important;margin-block-end:var(--cms-editorjs-space-after)!important}.editorjs-block+.editorjs-block,.editorjs-block:first-child{margin-block-start:0!important}.editorjs-block:last-child{margin-block-end:0!important}.editorjs-image img,.editorjs-gallery img,.editorjs-carousel img,.editorjs-drawing img,.editorjs-media-text img{box-sizing:border-box;max-width:100%!important;height:auto!important}.editorjs-media-text{display:flex;flex-wrap:wrap;align-items:flex-start;gap:1.5rem}.editorjs-media-text--image-right{flex-direction:row-reverse}.editorjs-table{overflow-x:auto}.editorjs-spacer{--cms-editorjs-space-after:0rem;--cms-editorjs-spacer-height:40px;display:block!important;clear:both;width:100%;height:var(--cms-editorjs-spacer-height)!important;min-height:var(--cms-editorjs-spacer-height)!important;margin:0!important;padding:0!important;line-height:0;font-size:0;overflow:hidden}';
