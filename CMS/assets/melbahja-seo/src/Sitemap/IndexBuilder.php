...
class IndexBuilder implements SitemapBuilderInterface
{
	...
	public function __construct(
		...
		switch ($mode)
		{
			...
			case OutputMode::STREAM:
				...
				$this->stream = $stream ?? self::openDefaultStream();

				if (method_exists(XMLWriter::class, 'toStream')) {

					$this->writer = XMLWriter::toStream($this->stream);
	...
	/**
	 * Open a safe default stream for non-CLI SAPIs.
	 *
	 * @return resource
	 */
	private static function openDefaultStream()
	{
		...
		throw new SitemapException('Unable to open sitemap output stream.');
	}
