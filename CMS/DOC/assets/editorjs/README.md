...
- `mediaText`/Text+Bild-Blöcke unterstützen zusätzlich eine optionale Überschrift sowie getrennte Abstände oberhalb und unterhalb des Blocks. Die optionale Überschrift wird semantisch als H3 gerendert und nutzt in Admin-Vorschau sowie Public-Ausgabe den H3-Maßstab. Ist „Dezenter Rahmen“ aktiv, wird sie als angedocktes Band am oberen Rahmen gerendert.
