...
if (!function_exists('cms_default_theme_customizer_source_verify_csrf')) {
    function cms_default_theme_customizer_source_verify_csrf(): bool
    {
...
$config = [
    ...
    'footer' => [
        'title' => '🔻 Footer',
        'sections' => [
            'show_footer_menu_area' => [
                'label'       => 'Oberen Footer-Menübereich anzeigen',
                'description' => 'Blendet den oberen Footer-Bereich mit Brand-Spalte, Social-Icons und Footer-Menüs ein oder aus.',
                'type'        => 'checkbox',
                'default'     => true,
            ],
            'footer_description' => [
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'reset_theme_tab') {
    if (!cms_default_theme_customizer_source_verify_csrf()) {
