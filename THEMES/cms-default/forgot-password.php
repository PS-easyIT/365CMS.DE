    ...
    <div class="auth-card">
        ...
        <?php if ($step === 'done'): ?>
            ...
            <div class="alert alert-success" style="padding:.85rem 1.2rem;background:#d1fae5;color:#065f46;border-radius:var(--r);margin-bottom:1.5rem;font-size:.9rem;">
                ✅ <?php echo htmlspecialchars($fpSuccess, ENT_QUOTES, 'UTF-8'); ?>
            </div>
            <?php endif; ?>
        ...
        <p class="auth-switch" style="text-align:center;margin-top:1.5rem;font-size:.86rem;color:var(--ink-muted);">
            <a href="<?php echo SITE_URL; ?>/login" style="color:var(--accent);">← Zurück zur Anmeldung</a>
        </p>
