...
$copyrightText  = meridian_setting('footer', 'copyright_text', '© ' . date('Y') . ' ' . $logoText . '. Alle Rechte vorbehalten.');
...
<footer>
  ...
  <div class="footer-main">
    ...
    <!-- Brand Column -->
    <div class="ft-brand">
      <a href="<?php echo SITE_URL; ?>/" class="site-logo-ft">
    ...
    <!-- Themes Column -->
    <div class="ft-col">
      <h5><?php echo htmlspecialchars($col1Title); ?></h5>
      <?php
    ...
    <!-- Resources Column -->
    <div class="ft-col">
      <h5><?php echo htmlspecialchars($col2Title); ?></h5>
    ...
    <!-- About Column -->
    <div class="ft-col">
      <h5><?php echo htmlspecialchars($col3Title); ?></h5>
  ...
  <div class="footer-bottom">
    <span class="copy"><?php echo htmlspecialchars($copyrightText); ?></span>
...
<script src="<?php echo SITE_URL; ?>/themes/cms-default/js/theme.js?v=<?php echo defined('MERIDIAN_THEME_VERSION') ? MERIDIAN_THEME_VERSION : '1.0.0'; ?>"></script>
