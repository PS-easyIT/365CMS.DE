...
} catch (\Throwable $e) { $footerText = ''; $imprintTitle = ''; $copyrightTpl = '&copy; {year} {site_title}.'; }
...
?>
    ...
    <footer id="mc-footer" class="mc-footer" role="contentinfo">
        <div class="mc-container">
            <div class="mc-footer-widgets">
                <div>
                    ...
                    <?php if (!empty($imprintTitle)) : ?><p style="margin-top:.75rem;font-size:var(--font-xs);opacity:.6;"><?php echo $safe($imprintTitle); ?></p><?php endif; ?>
                </div>
        ...
        <div class="mc-footer-bottom"><div class="mc-container"><?php echo $copyright; ?></div></div>
    </footer>
</div><!-- #page -->
