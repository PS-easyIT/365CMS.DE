...
| **Pages & Posts** | Content structure, editorial content, comments and supporting content blocks | Create, edit, organize, publish content, moderate comments with quick filters and keep slug/taxonomy links stable; the desktop editor now starts top-aligned in both pages and posts with a compact right sidebar and no large vertical gaps, while SEO-related panels from the SEO card onward use consistent collapsible headers. The SEO default notice remains intentionally subtle with a clear title above the actions; reset buttons stay side-by-side on desktop and wrap safely for longer labels without horizontal overflow |
