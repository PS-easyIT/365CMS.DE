...
**Version:** [2.9.775](Changelog.md) · **Status:** Stable · **PHP:** 8.4+ · **MySQL:** 5.7+ · **MariaDB:** 10.3+ 
...
| **Medien** | Bibliothek, Beitrags & Site Medien, Kategorien, Einstellungen, direkte Verwendungsanzeige, erweiterte Filter, Duplikat-Erkennung, WebP-/Thumbnail-Jobs und Dateimanagement | Uploads verwalten, Dateien organisieren, Medien nach Typ, Endung, Größe, Änderungszeitraum und Verwendung eingrenzen, direkt sehen, welche Beiträge oder Seiten eine Datei nutzen, identische Dateien anhand eines Inhalts-Hashs sichtbar machen, Beitrags-/Seitenbilder mit festem Bildvertrag gezielt ersetzen und bestehende Bilder in kleinen, fortsetzbaren Batches für WebP/Thumbnails nachverarbeiten |
