...
**Version:** [2.9.784](Changelog.md) · **Status:** Stable · **PHP:** 8.4+ · **MySQL:** 5.7+ · **MariaDB:** 10.3+ 
...
| **Medienverwaltung** | Uploads, Ordner, Kategorien, Bild-/Dateiverwaltung, Beitrags-/Site-Medien, Grid-/Listenansicht, direkte Verwendungsanzeige, Featured-Image-Konsistenzcheck, WebP-/Thumbnail-Jobs, erweiterte Filter und hashbasierte Duplikat-Erkennung | Verhindert Medien-Chaos und hält Assets auch bei wachsenden Projekten schnell nutzbar – inklusive gezieltem Ersetzen von Beitrags- und Seitenbildern, read-only Prüflisten für fehlende oder defekte Featured Images, serverseitigen Filtern nach Typ/Endung/Größe/Änderungszeitraum, direkt sichtbaren Beitrags-/Seitenreferenzen, read-only Hinweisen auf identische Dateien sowie chunkbasierter Nachverarbeitung bestehender Bilder mit Fortschrittsanzeige |
