...
**Version:** [2.9.724](Changelog.md) · **Status:** Stable · **PHP:** 8.4+ · **MySQL:** 5.7+ · **MariaDB:** 10.3+ 
...
| **Medienverwaltung** | Uploads, Ordner, Kategorien, Bild-/Dateiverwaltung, Beitrags-/Site-Medien, Grid-/Listenansicht, WebP-Workflows und hashbasierte Duplikat-Erkennung | Verhindert Medien-Chaos und hält Assets auch bei wachsenden Projekten schnell nutzbar – inklusive gezieltem Ersetzen von Beitrags- und Seitenbildern sowie read-only Hinweisen auf identische Dateien |
...
| **Medien** | Bibliothek, Beitrags & Site Medien, Kategorien, Einstellungen, Duplikat-Erkennung und Dateimanagement | Uploads verwalten, Dateien organisieren, identische Dateien anhand eines Inhalts-Hashs sichtbar machen, Beitrags-/Seitenbilder mit festem Bildvertrag gezielt ersetzen und Medien für Inhalte vorbereiten |
