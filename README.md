...
| **Seiten & Beiträge** | Content-Struktur, redaktionelle Inhalte, Kommentare und Inhaltsbausteine | Inhalte erstellen, strukturieren, pflegen, veröffentlichen, Kommentare mit Schnellfiltern moderieren und stabile Slug-/Taxonomie-Pfade erhalten; der Desktop-Editor startet dabei in Seiten sowie in neuen und bestehenden Beiträgen oben bündig, die rechte Sidebar läuft ohne editorbedingte Vertikallücken Card-auf-Card und führt SEO-Bereiche ab der SEO-Card mit einheitlichen, aufklappbaren Headern. Der SEO-Default-Hinweis bleibt bewusst strikt reduziert auf eine klare Titelzeile plus horizontal ausgerichtete Reset-Buttons, damit der Bereich im Desktop-Flow professionell und sofort erfassbar bleibt |
...
| **Pages & Posts** | Content structure, editorial content, comments and supporting content blocks | Create, edit, organize, publish content, moderate comments with quick filters and keep slug/taxonomy links stable; the desktop editor now starts top-aligned in both pages and posts with a compact right sidebar and no large vertical gaps, while SEO-related panels from the SEO card onward use consistent collapsible headers. The SEO default notice stays intentionally subtle, removes extra descriptive text and keeps reset actions aligned side by side in the same restrained admin visual language |
