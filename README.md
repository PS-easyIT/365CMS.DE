...
**Version:** [2.9.771](Changelog.md) · **Status:** Stable · **PHP:** 8.4+ · **MySQL:** 5.7+ · **MariaDB:** 10.3+ 
...
| **Diagnose & Monitoring** | Systemprüfungen, Laufzeitstatus, technische Kontrollansichten und ZIP-Diagnoseexporte | Probleme eingrenzen, Betriebszustand prüfen und technische Auffälligkeiten erkennen; lokale Health-Endpunkte werden dabei wirklich gegen die eigene Installation getestet statt nur als aktiv gespeichert, `/admin/cms-logs` spiegelt operative Audit- und Update-Spuren nun direkt im Diagnosekontext und redigierte Diagnoseberichte lassen sich POST-/CSRF-geschützt als ZIP bündeln statt sensible Werte in eine Download-URL zu legen |
