...
**Version:** [2.9.737](Changelog.md) · **Status:** Stable · **PHP:** 8.4+ · **MySQL:** 5.7+ · **MariaDB:** 10.3+ 
...
| **Aboverwaltung** | Pakete, Bestellungen, Limits, Zuweisungen, Renewal-Hinweise und abonnahes Business-Handling | Pakete verwalten, Zugriffe staffeln, Bestell- und Paketlogik steuern; konfigurierte Standardpakete wirken dabei auch für neue Mitglieder tatsächlich zur Laufzeit, Renewal-/Ablaufhinweise werden read-only aus echten Vertragsdaten abgeleitet und `/admin/orders` bietet sichere CSV-Exporte für Bestellungen sowie Paketnutzung |
