...
- Folgeaudit Remote-/Archivpfade: Update- und Backup-Restore-ZIP-Verträge weiter gegen Root-Overwrite, Symlinks, Größenbomben und Staging-Ausbruch gehärtet.
- Folgeaudit Shared Editor: AI-Translation-Requests, Editor.js-Payloads und SEO-Liveanalyse client- und serverseitig auf Same-Origin, Größe, Timeout und Strukturvalidität eingegrenzt.
