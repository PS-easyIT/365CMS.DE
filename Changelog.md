...
|---------|-----|---------|-------------|
| **2.9.248** | 🔴 fix | Admin/Theme Editor Customizer-Speichern | **`CMS/admin/theme-editor.php` synchronisiert die CSRF-Aktion der Theme-Editor-Shell mit den eingebundenen Theme-Customizern**: Der `cms-phinit`-Customizer kann Tabs wie „Startseite · Empfohlene Artikel“ nun wieder inline speichern, statt vor dem Theme-POST-Handler auf die Theme-Editor-Übersicht zurückgeleitet zu werden und den alten Wert stehen zu lassen. |
