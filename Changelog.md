...
| **2.9.248** | 🔴 fix | Core/Security Zweitprüfung & Fremdassets | **`CMS/themes/cms-default/functions.php`, `CMS/themes/cms-default/includes/theme-class.php`, `CMS/core/Security.php`, `CMS/.htaccess`, `CMS/core/Services/EditorJs/EditorJsAssetService.php`, `CMS/assets/js/editor-init.js` und `CMS/core/Services/EditorJsRenderer.php` entfernen externe Runtime-Font- und Embed-Ladevorgänge**: Google-Fonts-Preconnect/CSS wird nicht mehr im Public-Theme ausgegeben, CSP-Fallbacks erlauben keine Remote-Fonts mehr, Editor.js lädt die externen Embed-/Columns-Bundles nicht mehr, bestehende Embed-Blöcke rendern nur noch als sicherer Link statt als Fremd-Iframe, und README/Changelog verzichten auf externe Badge-/Screenshot-Assets. |
